...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubSearchLoader == null) {
            loaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBunidle, this);
        } else {
            loaderManager.restartLoader(GITHUB_SEARCH_LOADER, queryBunidle, this);
        }
    }
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                if (bundle.getString(SEARCH_QUERY_URL_EXTRA) == null)
                    return null;

                // COMPLETE (12) Copy the try / catch block from the AsyncTask's doInBackground method
                try {
                    URL githubUrl = new URL(bundle.getString(SEARCH_QUERY_URL_EXTRA));
